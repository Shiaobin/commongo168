...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="formTable" rules="all">
  ...
  <?php if (sizeof( $car_items ) > 0) { // Show if recordset not empty ?>
	  ...
	  $count = 0;
		...
		?>
          <tr>
            ...
            <td align="center">
              <?php echo $car_item->_goods_quantity; ?>
            </td>
	...
	?>
    <tr>
    <td align="center" colspan="6"><font size="5px">尚未挑選商品</font></td>
    </tr>
    <?php
	}
	?>
