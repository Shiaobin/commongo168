     ...
     <?php include("include/banner.php"); ?>     
        ...
        <!--頁頭flash end.jumbotron-->
          ...
          <?php 
			...
			?>
                ...
                <li class="font-small"><a href="prodshow.php?LarCode=<?php echo $LarCode; ?>&MidCode=<?php echo $MidCode; ?>&ProdId=<?php echo $ProdId; ?>&ProdNum=<?php echo $ProdNum; ?>"><?php echo $_GET['ProdId']; ?></a></li>
			<?php
			 }	 
			?>
            <li class="font-small">購物車</li> 
        ...
        <div class="row" id="content-box">
          ...
          <div class="col-sm-8 col-sm-push-3 col-xs-12" id="content">
           <?php include("include/site/showcart.php"); ?>
