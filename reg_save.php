...
if($pass==1){
 $Str=$Birthday."-".$D1."-".$D2;
 $query_Add= "INSERT into usermain(UserId,UserPassword,UserMail,UserName,UserQQ,Sex,Maritalstatus,Birthday,IncomeRange,Occupation,CompanyName,CompPhone,HomePhone,Address,ZipCode,Memo,WantMessage,UserKou)     values('".$UserId."','".$UserPassword."','".$UserMail."','".$UserName."','".$UserQQ."','".$Sex."','".$Maritalstatus."','".$Str."','".$IncomeRange."','".$Occupation."','".$CompanyName."','".  $CompPhone ."','".$HomePhone."','".$Address."','".$ZipCode."','".$Memo."','".$WantMessage."','".$thiskou."')";
