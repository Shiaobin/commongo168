     ...
     <?php include("include/banner.php"); ?>
        ...
        <div class="row" id="content-box">
          <div class="col-sm-8 col-sm-push-3 col-xs-12" id="content">
            ...
            <?php
			$rs_class = selectOne($webshop,"LarCode","prodclass","1=1","LarSeq ASC");
			if(isset($LarCode)) $whereClause = "LarCode='".$LarCode."' AND online=1";
			else $whereClause = "online=1";
			if(isset($LarCode) && (isset($MidCode))) $whereClause = "LarCode='".$LarCode."' AND MidCode='".$MidCode."' AND online=1";
			$per_page = 18; //每頁顯示的筆數
             if(isset($_GET['page'])){
	         $page=$_GET['page'];
             }else{
