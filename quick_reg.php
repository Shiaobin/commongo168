...
<tr><td>真實姓名<font color=red>*</font>:<input name="UserName" placeholder="請輸入您的真實姓名" type="text" size="25"  class="input-medium"  >
              </td></tr>
<tr><td>登入密碼<font color=red>*</font>:<input name="pw1" placeholder="長度：5至10個字符" type="password" size="25"  class="input-medium"  >
               </td>
          </tr>
