...
$sql="select * from prodclass C, prodmain N where C.LarCode=N.LarCode and C.MidCode=N.MidCode and N.ProdId='".$_GET["id"]."' and N.Online=1 order by N.LarCode,N.MidCode desc";
$db->query($sql);
$i=0;
